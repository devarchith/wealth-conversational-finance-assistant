...
describe("client utilities",()=>{
 ...
 it("formats metrics without inventing unavailable rates",()=>{expect(formatPercent(0.256)).toBe("26%");expect(formatPercent(null)).toBe("Not available");expect(formatMoney(1200,"USD")).toContain("1,200");});
});
